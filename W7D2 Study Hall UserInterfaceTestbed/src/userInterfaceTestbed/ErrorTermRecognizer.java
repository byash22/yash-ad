...
public class ErrorTermRecognizer {
	 ...
	 * @author Yash
	 * 
	 * @version 4.012018-02-20	Initial baseline 
	 * 
	 */
	...
	public static String checkErrorTerm(String input, int currentCharNdx) {
		...
		case 1:
			...
			if (currentCharNdx<input.length()) {
				...
				return errorTermErrorMessage + checkErrorTerm(input, currentCharNdx);
			}
			else {
