...
public class MeasuredValueRecognizer {
	 ...
	 * 
	 * <p> Copyright: Yash © 2018 </p>
	 * 
	 * @author Yash
	 * 
	 * @version 4.01 2018-02-20	Initial baseline 
	 * 
	 */
	...
	public static String checkMeasureValue(String input) {
		...
		while (running) {
			...
			case 5: 
				...
				// If the current character is an '+' or '-" symbol, it transitions to state 6
				else if (currentChar == '+' || currentChar == '-') {
					nextState = 6;
					break;
				}
				// If none of those characters, the FSM halts
				else
					running = false;
				// The execution of this state is finished
				break;
			...
			case 6: 
				// State 6 has one valid transition, and is addressed by an if statement.
